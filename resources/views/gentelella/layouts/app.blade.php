			...
			<div class="main_container">
					...
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0; text-align: center">
							...
							<a href="{{ route('home')}}" class="site_title">
								...
								<span style="color: #bfa15f; ">CCO</span>
				...
				<footer>
					<div class="pull-right">
						© 2021 Equipe de Desenvolvimento de Sistemas - Subsecretaria da Tecnologia da Informação - Prefeitura Municipal de Mesquita - RJ <i  style="font-size: 18px" class="fab fa-free-code-camp"></i> 
					</div>
					<div class="clearfix"></div>
				</footer>
			</div>
